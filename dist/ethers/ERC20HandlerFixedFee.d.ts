...
export interface ERC20HandlerFixedFeeInterface extends utils.Interface {
    contractName: "ERC20HandlerFixedFee";
    functions: {
...
export interface ERC20HandlerFixedFee extends BaseContract {
    contractName: "ERC20HandlerFixedFee";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC20HandlerFixedFeeInterface;
