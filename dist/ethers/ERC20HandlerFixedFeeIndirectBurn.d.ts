...
export interface ERC20HandlerFixedFeeIndirectBurnInterface extends utils.Interface {
    contractName: "ERC20HandlerFixedFeeIndirectBurn";
    functions: {
        "_bridgeAddress()": FunctionFragment;
        "_burnList(address)": FunctionFragment;
        "_contractWhitelist(address)": FunctionFragment;
        "_feeChain(uint8)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "_feeChain", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "_feeChain", data: BytesLike): Result;
...
export interface ERC20HandlerFixedFeeIndirectBurn extends BaseContract {
    contractName: "ERC20HandlerFixedFeeIndirectBurn";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC20HandlerFixedFeeIndirectBurnInterface;
    ...
    functions: {
        ...
        _feeChain(arg0: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    populateTransaction: {
        ...
        _feeChain(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
