...
export interface ERC20HandlerPercentageFeeInterface extends utils.Interface {
    contractName: "ERC20HandlerPercentageFee";
    functions: {
...
export interface ERC20HandlerPercentageFee extends BaseContract {
    contractName: "ERC20HandlerPercentageFee";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC20HandlerPercentageFeeInterface;
